...
const faMessages: Record<string, string> = {
  ...
  "Vision unknown": "تصویر نامشخص",
  "Tools unknown": "ابزارها نامشخص",
  "Search subscription models": "جست‌وجوی مدل‌های اشتراک",
  "No live model list yet": "هنوز فهرست زندهٔ مدل دریافت نشده است",
  "Choose a provider-reported model or enter its exact ID. Leave blank to use the subscription default.": "مدل گزارش‌شده توسط ارائه‌دهنده را انتخاب کنید یا شناسهٔ دقیق آن را وارد کنید. برای استفاده از پیش‌فرض اشتراک، خالی بگذارید.",
  Default: "پیش‌فرض",
  "5-hour": "۵ ساعته",
  Weekly: "هفتگی",
  remaining: "باقی‌مانده",
  "Reset {time}": "بازنشانی {time}",
  "Limits unavailable": "محدودیت‌ها در دسترس نیستند",
  "Refresh limits": "تازه‌سازی محدودیت‌ها",
  "Limits are reported by the signed-in provider runtime, not estimated locally.": "محدودیت‌ها توسط اجرای واردشدهٔ ارائه‌دهنده گزارش می‌شوند و به‌صورت محلی برآورد نمی‌شوند.",
  ...
  "Thread action": "عملیات رشته",
  "Delete this thread?": "این رشته حذف شود؟",
  "Local task history for this thread will be removed.": "تاریخچهٔ محلی وظیفه‌های این رشته حذف می‌شود.",
  "The thread could not be deleted.": "رشته حذف نشد.",
  "Delete thread": "حذف رشته",
